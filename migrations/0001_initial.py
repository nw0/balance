# Generated by Django 2.0 on 2017-12-16 16:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='GBP', max_digits=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='GBP', max_digits=16)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='balance.TransactionCategory'),
        ),
        migrations.AddField(
            model_name='transaction',
            name='owner',
        ...
        migrations.AddField(
            model_name='transaction',
            name='payee',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='payee', to='balance.Account'),
        ),
        migrations.AddField(
            model_name='transaction',
            name='payer',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='payer', to='balance.Account'),
        ),
    ]
