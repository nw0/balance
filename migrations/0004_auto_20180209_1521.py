# Generated by Django 2.0 on 2018-02-09 15:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('balance', '0003_auto_20171217_1454'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accounts', models.ManyToManyField(to='balance.Account')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='balance.Budget')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='balance.TransactionCategory')),
            ],
        ),
        migrations.AlterModelOptions(
            name='transaction',
            options={'get_latest_by': ['date', 'pk']},
        ),
        migrations.AddField(
            model_name='budget',
            name='categories',
            field=models.ManyToManyField(through='balance.BudgetAllocation', to='balance.TransactionCategory'),
        ),
        migrations.AddField(
            model_name='budget',
            name='owner',
